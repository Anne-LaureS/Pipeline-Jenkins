...
|---|---|---|
| Contrôleur Jenkins | `al-jenkins-tp` (13.36.171.149) | Provisionné au TP1, sert aussi de cible Ansible `web_lab` (TP5/TP7) |
| Agent Jenkins | `al-jenkins-agent-tp4` (label `aws-lab`) | Provisionné au TP4 — Git, Java, AWS CLI, Python, Ansible |

Les deux tournent sur le compte AWS de labo partagé (type Academy), région `eu-west-3`.

## Sommaire des TP

| TP | Contenu | Fiche |
|---|---|---|
| [TP1](TP_1/) | Déploiement du serveur Jenkins sur EC2 (script + user-data) | [fiche-configuration-TP1.md](TP_1/fiche-configuration-TP1.md) |
| [TP2](TP_2/) | Connexion Jenkins ↔ AWS, credential dédié, job `aws-identity-check` | [fiche-configuration-TP2.md](TP_2/fiche-configuration-TP2.md) |
| [TP3](TP_3/) | Jenkinsfile déclaratif paramétré (job de base → paramétré → 4 stages) | [fiche-configuration-TP3.md](TP_3/fiche-configuration-TP3.md) |
| [TP4](TP_4/) | Agent Jenkins dédié (`aws-lab`), job amont/aval | [fiche-configuration-TP4.md](TP_4/fiche-configuration-TP4.md) |
| [TP5](TP_5/) | Playbook Ansible idempotent, lint + check/diff + approbation manuelle | [fiche-configuration-TP5.md](TP_5/fiche-configuration-TP5.md) |
| [TP6](TP_6/) | AWS CLI et gestion réseau (Security Group taggé, règle restreinte) | [fiche-configuration-TP6.md](TP_6/fiche-configuration-TP6.md) |
| [TP7](TP_7/) | Projet global : catalogue de 3 jobs (inventaire/déploiement/nettoyage) | [rapport-TP7.md](TP_7/docs/rapport-TP7.md) |
...
- **Limitation connue** : le compte AWS de labo interdit la gestion IAM en self-service — documenté et
